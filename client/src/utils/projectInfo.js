...
const front = [
    ...
    new Project("Crystal Collector", "https://github.com/Foscat/unit-4-game", " https://foscat.github.io/unit-4-game/",
        "Crystals get randomly assigned numbers and a target number is randomly generated. Clicking a crystal adds its value to total. Try to get total to match target score.",
